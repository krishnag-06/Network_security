...
class DataTransformation:
    ...
    def get_transformer_obkect(cls) -> Pipeline:
        logging.info("Entered get_data_transformer_object method of transformation class")
        try:
            imputer = KNNImputer(**DATA_TRANSFORAMTION_IMPUTER_PARAMS)
            logging.info(f"Initialise KNNImputer with {DATA_TRANSFORAMTION_IMPUTER_PARAMS}")
    ...
    def initiate_data_transformation(self) -> DataTransformationArtifact:
        ...
        try:
            ...
            preprocessor = self.get_transformer_obkect()
